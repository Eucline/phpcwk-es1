...
class MySQLWrapper
{
  ...
  public function store_messages($p_msg_source, $p_msg_time, $p_msg_message)
  {
    $m_query_string = $this->c_obj_sql_queries->create_msg_var();

    $m_arr_query_parameters = [
      ':p_msg_source' => $p_msg_source,
      ':p_msg_time' => $p_msg_time,
      ':p_msg_message' => $p_msg_message
    ];
