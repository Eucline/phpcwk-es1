...
$container['message_model'] = function ($container) {
  $class_path = $container->get('settings')['class_path'];
  require $class_path . 'MessageHandlerModel.php';
  $model = new MessageHandlerModel();
  return $model;
};

$container['dbmsg_model'] = function ($container) {
    $class_path = $container->get('settings')['class_path'];
    require $class_path . 'DatabaseHandlerModel.php';
    $model = new DatabaseHandlerModel();
    return $model;
};
